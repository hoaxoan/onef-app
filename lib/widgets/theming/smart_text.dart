...
class OBSmartText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    OneFProviderState oneFProvider = OneFProvider.of(context);
    ThemeService themeService = oneFProvider.themeService;
    ThemeValueParserService themeValueParserService =
        oneFProvider.themeValueParserService;

    double fontSize = OFText.getTextSize(size);
