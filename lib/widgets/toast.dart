...
class OFToast extends StatefulWidget {
  final Widget child;

  OFToast({this.child});

  @override
  OFToastState createState() {
    return OFToastState();
  }

  static OFToastState of(BuildContext context) {
    final OFToastState toastState =
        context.rootAncestorStateOfType(const TypeMatcher<OFToastState>());
    toastState._setCurrentContext(context);
    return toastState;
  }
}

class OFToastState extends State<OFToast> with SingleTickerProviderStateMixin {
