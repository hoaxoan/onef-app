...
import 'package:onef/widgets/video_player/widgets/chewie/chewie_progress_colors.dart';
import 'package:onef/widgets/video_player/widgets/chewie/material_progress_bar.dart';
import 'package:onef/widgets/video_player/widgets/utils.dart';
import 'package:video_player/video_player.dart';

import '../../icon.dart';

class OFVideoPlayerControls extends StatefulWidget {
  ...
  final OFVideoPlayerControlsController controller;

  const OFVideoPlayerControls(
      {Key key,
  ...
  State<StatefulWidget> createState() {
    return OFVideoPlayerControlsState();
  }
}

class OFVideoPlayerControlsState extends State<OFVideoPlayerControls> {
  ...
  Widget _buildProgressBar() {
    ...
    OFTheme activeTheme = provider.themeService.getActiveTheme();

    Color actionsForegroundColor = provider.themeValueParserService
...
class OFVideoPlayerControlsController {
  OFVideoPlayerControlsState _state;

  OFVideoPlayerControlsController();
