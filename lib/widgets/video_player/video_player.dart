...
import 'package:onef/widgets/video_player/widgets/video_player_controls.dart';
...
class OFVideoPlayer extends StatefulWidget {
  final File video;
  ...
  final bool autoPlay;
  final OFVideoPlayerController controller;
  final double height;
  final double width;
  ...
  State<StatefulWidget> createState() {
    return OFVideoPlayerState();
  }
}

class OFVideoPlayerState extends State<OFVideoPlayer> {
  VideoPlayerController _playerController;
  ChewieController _chewieController;
  OFVideoPlayerControlsController _obVideoPlayerControlsController;
  UserPreferencesService _userPreferencesService;
  OFVideoPlayerController _controller;
  ...
  void initState() {
    super.initState();
    _controller = widget.controller == null ? OFVideoPlayerController() : widget.controller;
    _controller.attach(this);
    _obVideoPlayerControlsController = OFVideoPlayerControlsController();
    ...
    await retry(
      ...
      retryIf: (e) {
        ...
        bool willRetry = e is SocketException ||
            ...
            e is OFVideoPlayerInitializationException;
  ...
  Future _initializeVideo() async {
    ...
    if (_playerController.value?.hasError == true) {
      ...
      throw OFVideoPlayerInitializationException('Player controller had error');
    }
  ...
  void _onExpandCollapse(Function originalExpandFunction) async {
    ...
    var provider = OneFProvider.of(context);
    await provider.dialogService.showVideo(
        context: context,
        video: widget.video,
  ...
  ChewieController _getChewieController() {
    ...
    return ChewieController(
        ...
        customControls: OFVideoPlayerControls(
...
class OFVideoPlayerController {
  OFVideoPlayerState _state;
...
class OFVideoPlayerInitializationException implements Exception {
  String cause;

  OFVideoPlayerInitializationException(this.cause);
}
