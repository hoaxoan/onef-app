...
class OFLinkPreview extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return OFLinkPreviewState();
  }
}

class OFLinkPreviewState extends State<OFLinkPreview> {
  ...
  Widget build(BuildContext context) {
    if (_needsBootstrap) {
      ...
      _urlLauncherService = provider.urlLauncherService;
      _localizationService = provider.localizationService;
      _httpieService = provider.httpService;
                ...
                Expanded(
                  child: OFHighlightedBox(
                    child: Padding(
                      ...
                      child: OFSecondaryText(_getLinkPreviewDomain(),
            ...
            child: Row(
              ...
              children: <Widget>[
                _linkPreview.faviconUrl != null
                    ...
                    : const SizedBox(),
                OFSecondaryText(_getLinkPreviewDomain(),
                    overflow: TextOverflow.ellipsis,
                    maxLines: 1,
          ...
          _linkPreview.description != null
              ? Padding(
                  ...
                  child: OFSecondaryText(
                    ...
                    size: OFTextSize.mediumSecondary,
                    maxLines: 3,
                    overflow: TextOverflow.ellipsis,
                  ),
                )
