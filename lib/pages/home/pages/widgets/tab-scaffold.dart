...
class OFCupertinoTabScaffold extends StatefulWidget {
  ...
  ///
  /// Must not be null.
  final OFCupertinoTabBar tabBar;
  ...
  @override
  _OFCupertinoTabScaffoldState createState() => _OFCupertinoTabScaffoldState();
}

class _OFCupertinoTabScaffoldState extends State<OFCupertinoTabScaffold> {
  int _currentPage;
  ...
  @override
  void didUpdateWidget(OFCupertinoTabScaffold oldWidget) {
