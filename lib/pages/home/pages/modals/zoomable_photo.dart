...
class OFZoomablePhotoModal extends StatefulWidget {
  final String imageUrl;

  OFZoomablePhotoModal(this.imageUrl);

  @override
  State<StatefulWidget> createState() {
    return OFZoomablePhotoModalState();
  }
}

class OFZoomablePhotoModalState extends State<OFZoomablePhotoModal>
