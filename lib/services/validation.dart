...
class ValidationService {
  ...
  Future<bool> isImageAllowedSize(File image, OFImageType type) async {
  ...
  int getAllowedImageSize(OFImageType type) {
    if (type == OFImageType.avatar) {
      return AVATAR_IMAGE_MAX_SIZE;
    } else if (type == OFImageType.cover) {
