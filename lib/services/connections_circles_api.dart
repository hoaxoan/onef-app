...
class ConnectionsCirclesApiService {
  ...
  static const GET_CIRCLES_PATH = 'circles';
  static const CREATE_CIRCLE_PATH = 'circles';
  static const UPDATE_CIRCLE_PATH = 'circles/{circleId}/';
  static const DELETE_CIRCLE_PATH = 'circles/{circleId}/';
  static const GET_CIRCLE_PATH = 'circles/{circleId}/';
  static const CHECK_NAME_PATH = 'circles/name-check/';
  ...
  Future<HttpieResponse> createCircle({@required String name, String color}) {
    ...
    return _httpService.postJSON(url, appendAuthorizationToken: true, body: body);
  }
  ...
  Future<HttpieResponse> updateCircleWithId(int circleId,
    ...
    return _httpService.patchJSON(url, appendAuthorizationToken: true, body: body);
  }
