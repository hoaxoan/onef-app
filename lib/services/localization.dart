...
import 'package:onef/locale/messages_all.dart';
import 'package:onef/main.dart';
...
class LocalizationService {
  ...
  static LocalizationService of(BuildContext context) {
    ...
    _onLoggedInUserChangeSubscription =
        provider.userService.loggedInUserChange.listen((User newUser) {
      ...
      if (_userLanguageCode != null &&
        ...
        OneFApp.setLocale(context, supportedMatchedLocale);
      }
  ...
  String get task__today {
    return Intl.message("Today", name: 'task__today');
  }

  String get task__scheduled {
    return Intl.message("Scheduled", name: 'task__scheduled');
  }

  String get task__flagged {
    return Intl.message("Flagged", name: 'task__flagged');
  }

  String get task__all {
    return Intl.message("All", name: 'task__all');
  }

  String get task__new_list {
