...
class StorageService {
  OFStorage getSecureStorage({String namespace}) {
    return OFStorage(store: _SecureStore(), namespace: namespace);
  }

  OFStorage getSystemPreferencesStorage({String namespace}) {
    return OFStorage(
...
class OFStorage {
  ...
  OFStorage({this.store, this.namespace});
